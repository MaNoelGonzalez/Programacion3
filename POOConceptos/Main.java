...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Crear instancia de FileHandler para cargar conceptos desde conceptos.data
       FileHandler fileHandler = new FileHandler("POOConceptos\\concetos.data");
